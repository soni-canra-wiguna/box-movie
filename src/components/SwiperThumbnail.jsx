                ...
                >
                  <Link to={`/${type}/${id}`} className="h-full w-full">
                    <img
                      ...
                      className="h-full w-full object-cover object-center transition duration-500 ease-in-out hover:brightness-[.80]"
                    />
                    <h1 className="absolute bottom-0 w-full bg-black/70 px-3 py-2 text-center font-medium">
...
export const CardLoader = () => {
  return (
    <div className="h-[300px] w-[210px] animate-pulse rounded-md bg-gray-200"></div>
  )
}
